...
class GaragesControllerTest < ActionController::TestCase
  ...
  test "should create garage" do
    assert_difference('Garage.count') do
      post :create, garage: { color: @garage.color, location: @garage.location, size: @garage.size, user_id: @garage.user_id }
    end
  ...
  test "should update garage" do
    patch :update, id: @garage, garage: { color: @garage.color, location: @garage.location, size: @garage.size, user_id: @garage.user_id }
    assert_redirected_to garage_path(assigns(:garage))
  end
